...
${formData.message}`;
    ...
    const whatsappUrl = `https://wa.me/6285885725027?text=${encodeURIComponent(whatsappMessage)}`;
    ...
    <section id="contact" className="py-20 px-4">
      <div className="container mx-auto max-w-6xl">
        ...
        <p className="text-center text-gray-600 dark:text-gray-400 mb-12">
          Let's work together! Fill out the form and connect via WhatsApp.
        </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows={6}
                  className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-green-500 dark:bg-gray-800 dark:text-white resize-none"
